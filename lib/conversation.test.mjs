...
test("new ad sales objection beats opening flow", async () => {
...
test("any first message from a new customer starts the product opening flow", async () => {
  const plan = await buildConversationPlan({
    catalog,
    customer: {
      id: "new_customer_any_first_message",
      productId: "",
      inboundCount: 1,
    },
