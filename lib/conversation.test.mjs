...
test("new ad price question receives opening flow before RAG price answer", async () => {
  const plan = await buildConversationPlan({
    catalog,
...
test("new customer product name plus price question receives opening flow before RAG answer", async () => {
  const cases = [
