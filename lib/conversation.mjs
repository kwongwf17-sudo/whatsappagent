...
export function shouldSendProductOpeningFlow(customer = {}, product = null, customerMessage = "", source = {}) {
  ...
  return (
    ...
    isFirstInboundNewCustomerOpening(customer) ||
...
function isFirstInboundNewCustomerOpening(customer = {}) {
  if (customer?.productId || customer?.openingFlowProductId) return false;
  return Number(customer?.inboundCount || 0) <= 1;
}
